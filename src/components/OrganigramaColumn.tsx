  ...
  return (
    ...
    >
      <div className="mb-2 flex items-center gap-1.5 px-0.5">
        ...
        <span className="flex shrink-0 items-center gap-1 rounded-full bg-slate-200/70 px-2 py-0.5 text-[11px] font-medium text-slate-600 dark:bg-slate-700 dark:text-slate-300">
      ...
      <div className="flex min-h-[3rem] flex-col gap-1.5">
        ...
        {people.length === 0 && (
          <p className="rounded-lg border border-dashed border-slate-300 py-4 text-center text-[11px] text-slate-400 dark:border-slate-600 dark:text-slate-500">
            Sin funcionarios
          </p>
        )}
      </div>
